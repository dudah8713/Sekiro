...
struct Z_CompiledInDeferFile_FID_Work_Sekiro_SekiroProj_Source_SekiroProj_SekiroGame_Components_Combat_PlayerCombatComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPlayerCombatComponent, UPlayerCombatComponent::StaticClass, TEXT("UPlayerCombatComponent"), &Z_Registration_Info_UClass_UPlayerCombatComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlayerCombatComponent), 2716868192U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_Sekiro_SekiroProj_Source_SekiroProj_SekiroGame_Components_Combat_PlayerCombatComponent_h_1547367431(TEXT("/Script/SekiroProj"),
