...
struct Z_CompiledInDeferFile_FID_Work_Sekiro_SekiroProj_Source_SekiroProj_SekiroGame_Items_Weapons_SekiroWeaponKatana_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASekiroWeaponKatana, ASekiroWeaponKatana::StaticClass, TEXT("ASekiroWeaponKatana"), &Z_Registration_Info_UClass_ASekiroWeaponKatana, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASekiroWeaponKatana), 2450306525U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_Sekiro_SekiroProj_Source_SekiroProj_SekiroGame_Items_Weapons_SekiroWeaponKatana_h_3833396763(TEXT("/Script/SekiroProj"),
